...
namespace Hanafalah\ModulePayment\Supports\Condition;

use Illuminate\Database\Eloquent\Collection;
use Illuminate\Database\Eloquent\Model;
use Hanafalah\ModulePayment\Contracts\Supports\Condition\Condition as ConditionInterface;
...
class Condition extends PackageManagement implements ConditionInterface
{
    ...
    public function validation(Model &$voucher, array &$attributes): array
    {
        ...
        foreach ($voucher_rules as &$voucher_rule) {
            ...
            $condition_schema         = app(config('module-payment.voucher.conditions.condition_' . Str::snake(Str::lower($voucher_rule->condition))));
    ...
    {
        $benefit_schema  = app(config('module-payment.voucher.benefit_targets.benefit_' . Str::snake(Str::lower($voucher->benefit_target))));
