...
namespace Hanafalah\ModulePayment\Facades;
 ...
 */
class ModulePayment extends \Illuminate\Support\Facades\Facade
{
  /**
  ...
  {
    return \Hanafalah\ModulePayment\Contracts\ModulePayment::class;
  }
}
